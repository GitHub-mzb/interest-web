<style scoped>
    .index {
        ...
        background:url(../images/login.jpg) fixed no-repeat center center;
    ...
    #index_pc_bj{width:100%;height:auto;background-size:cover;overflow: hidden;background-position:center center;text-align: center;}
    /*具体内容*/
                            ...
                            <dl>
                                ...
                                <FormItem>
                                    ...
                                    <div style="width: 250px">
                                            <Icon  style="color: rebeccapurple;" size="40" ></Icon>
                                    </div>
                                </FormItem>
                            </dl>
                        </li>
