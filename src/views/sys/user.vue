                ...
                <Row>
                    ...
                    <Col span="12">
                        <Form-item label="性别:" prop="sex">
                            <Input v-model="userNew.sex" style="width: 204px"/>
                        </Form-item>
                    </Col>
                </Row>
                <Row>
                    <Col span="12">
                        <Form-item label="学号:" prop="num">
                            <Input v-model="userNew.num" style="width: 204px"/>
                        </Form-item>
                    </Col>
                    <Col span="12">
                        <Form-item label="班级:" prop="grade">
                            <Input v-model="userNew.grade" style="width: 204px"/>
                        </Form-item>
                    </Col>
                </Row>
                <Row>
                    <Col span="12">
                        <Form-item label="部门:" prop="department">
                            <Input v-model="userNew.department" style="width: 204px"/>
                        </Form-item>
                    </Col>
                    <Col span="12">
                        <Form-item label="职务:" prop="position">
                            <Input v-model="userNew.position" style="width: 204px"/>
                        </Form-item>
                    </Col>
                </Row>
            </Form>
    ...
    export default {
        ...
        methods:{
            ...
            initUserNew(){
                ...
                this.userNew.num =null;
                this.userNew.grade=null;
                this.userNew.sex=null;
                this.userNew.department=null;
                this.userNew.position=null;
                this.userNew.createTime=null;
            ...
            initUserModify(){
                ...
                this.userModify.num = null ;
                this.userModify.grade=null;
                this.userModify.sex = null;
                this.userModify.department=null;
                this.userModify.position=null;
                this.userModify.createTime=null;
            ...
            userSet(e){
                ...
                this.user.sex = e.sex;
                this.user.num = e.num;
                this.user.grade = e.grade;
                this.user.department = e.department;
                this.user.position = e.position;
                this.user.createTime=Date.parse(new Date());
            },
            /*userNew设置*/
            userNewSet(e){
                ...
                this.userNew.sex = e.sex;
                this.userNew.num = e.num;
                this.userNew.grade = e.grade;
                this.userNew.department = e.department;
                this.userNew.position = e.position;
                this.userNew.createTime=Date.parse(new Date());
            },
            /*userModify设置*/
            userModifySet(e){
